...
<div id="content">
    <p id="tombol-tambah-container">
        ...
        <a target="_blank" href="pages/cetak.php"><img src="print.jpg" height="50px" height="50px"></a>
        <a target="_blank" href="ekspor_pdf.php"><img src="cetakpdf.png" height="50px" height="50px"></a>
        <a target="_blank" href="ekspor_excel.php"><img src="cetakexcel.png" height="50px" height="50px"></a> 
