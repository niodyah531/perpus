...
<div id="content">
    <p id="tombol-tambah-container">
        ...
        <a target="_blank" href="pages/cetak_buku.php"><img src="print.jpg" height="50px" height="50px"></a>
        <a target="_blank" href="ekspor_pdf_buku.php"><img src="cetakpdf.png" height="50px" height="50px"></a>
        <a target="_blank" href="ekspor_excel_buku.php"><img src="cetakexcel.png" height="50px" height="50px"></a> 
